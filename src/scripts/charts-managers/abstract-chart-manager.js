...
export class AbstractChartManager {
  ...
  createLegend(svg, translateX, translateY, symbol) {
    return this.chartHelper.createLegend(svg, translateX, translateY, symbol, this.playerHelperSingleton.playersAttributes);
  }
}
